 ...
 * 2016-05-19T14:00:02.965-03:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "http://localhost:9090/ContractFirstWS/services/orders?wsdl",
                  targetNamespace = "http://www.site.com/service/Orders/") 
public class Orders_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.site.com/service/Orders/", "Orders");
    public final static QName OrdersSOAP = new QName("http://www.site.com/service/Orders/", "OrdersSOAP");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9090/ContractFirstWS/services/orders?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9090/ContractFirstWS/services/orders?wsdl");
        }
        WSDL_LOCATION = url;
    }
