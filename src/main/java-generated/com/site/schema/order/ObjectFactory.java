 ...
 * generated in the com.site.schema.order package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderInquiry_QNAME = new QName("http://www.site.com/schema/Order", "orderInquiry");
    private final static QName _OrderInquiryResponse_QNAME = new QName("http://www.site.com/schema/Order", "orderInquiryResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.site.schema.order
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.site.com/schema/Order", name = "orderInquiry")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.site.com/schema/Order", name = "orderInquiryResponse")
