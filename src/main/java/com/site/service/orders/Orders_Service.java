...
public class Orders_Service extends Service {
    ...
    static {
        URL url = Orders_Service.class.getClassLoader().getResource("orders.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:orders.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
